...
async function cargarModeloAI() {
    try {
        model = await tf.loadLayersModel('./modelo_web_final/model.json'); // Asegúrate que esta ruta apunte al modelo NUEVO
...
// 1. Extracción IDÉNTICA a Python (Adiós al bug del espejo)
